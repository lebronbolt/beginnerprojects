...
pygame.display.set_caption("X and O Bitch")
initiate_window = pygame.image.load("Modified_cover.png")
x_image = pygame.image.load("X_modified.png")
o_image = pygame.image.load("o_modified.png")

initiate_window = pygame.transform.scale(initiate_window, (width, height + 100))
...
def game_initiating_window():
    ...
    screen.blit(initiate_window, (0, 0))
