...
initiating_window = pg.image.load("resources/xando/modified_cover.png")
x_img = pg.image.load("resources/xando/X_modified.png")
y_img = pg.image.load("resources/xando/o_modified.png")
